...
export class EdituserComponent implements OnInit {
  ...
  this.editForm = this.fb.group({
      'city': ['City',  Validators.compose([Validators.required, Validators.minLength(3), Validators.maxLength(300)])],
      'country' : ["Country", Validators.required],
      'bio': ['Something about you!',  Validators.compose([Validators.required, Validators.minLength(20), Validators.maxLength(1000)])],
      'job': ['Occupation ',  Validators.compose([Validators.required, Validators.minLength(5), Validators.maxLength(100)])],
    });
  ...
  submitForm(id: string, value: any){
   ...
   this._authService.updateUser(id, value)
    .then((success) => {
      this.submitted = true;
      console.log('success'); 
    })
